...
int main(){
	FILE *fa;
	char type[][20]={"ArithmeticOperator", "RelationalOperator", "LogicalOperator", "SpecialSymbol", "Keyword", "NumConstant", "StrLiteral", "Identifier", "ShorthandOperator","IncrementOperator","DecrementOperator","AssignmentOperator"};
