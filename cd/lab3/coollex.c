...
{
	//symbol table
	printf("\nIndex\tName\tType\tNo of arg\targ index in tab\treturn\n");
...
void output(struct symbtable arr[50] , int tsize){
	...
	char buf[50];
	char na[3]=" ";
		char keyword[12][50]={"int","class","return","void","char","float","if","else","break","for","do","continue"};//keyword
...
int main()
{
	...
	char keyword[12][50]={"int","class","return","void","char","printf","if","else","break","for","do","continue"};//keyword
	int ca , cb ;
	int i ;
	fa = fopen("test3.cl","r");
	ca = getc(fa);
